...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR blue][B]CanDo[/B][/COLOR]Wizard'
BUILDERNAME = 'CanDo Wizard'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE = 'http://candoportal.ca/Wizard/candobuild.txt'
# How often you would like it to check for build updates in days
# 0 being every startup of kodi
UPDATECHECK = 0
# Text File with apk info in it.  Leave as 'http://' to ignore
APKFILE = 'http://candoportal.ca/Wizard/apk.txt'
...
THEME1 = '[COLOR '+COLOR1+'][I]([COLOR '+COLOR1+'][B]CanDo[/B][/COLOR][COLOR ' + COLOR2 + ']Wizard[COLOR ' + COLOR1 + '])[/I][/COLOR] [COLOR '+COLOR2+']{0}[/COLOR]'
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing CanDo Wizard. Please visit us at www.mycando.ca'
# Images used for the contact window.  http:// for default icon and fanart
CONTACTICON = os.path.join(ART, 'qricon.png')
CONTACTFANART = 'https://candoportal.ca/Wizard/IMG/ContactUs.jpg'
#########################################################
...
NOTIFICATION = 'http://candoportal.ca/Wizard/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = 'Update From CanDo'
